...
def pregunta_01():
    ...
    # Etiquete la primera columna como `msg` y la segunda como `lbl`. Esta funciÃ³n
    # retorna el dataframe con las dos columnas.
    df = pd.read_csv(
        # 'C:/Users/jlopezl/OneDrive - Renting Colombia S.A/Archivos/Personal/Especialización/Ciencia de los datos/analisis-de-sentimientos-amazon-JuanesLopez/amazon_cells_labelled.tsv',
...
def pregunta_04():
    """
    Especificacion del pipeline y entrenamiento
    -------------------------------------------------------------------------------------
    """
    ...
    # limite superior para la frecuencia de palabras es del 100% y un limite
    ...
    # Defina un diccionario de parametros para el GridSearchCV. Se deben
    # considerar 10 valores entre 0.1 y 1.0 para el parametro alpha de
    # BernoulliNB.
    param_grid = {
    ...
    # parÃ¡metros. Use cv = 5, y "accuracy" como mÃ©trica de evaluaciÃ³n
    ...
    # Busque la mejor combinacion de regresores
